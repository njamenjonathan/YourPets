...
import {
  ...
  User, ShieldCheck, HelpCircle, PhoneCall, BookOpen, Layers
} from 'lucide-react';
        ...
        <div className="flex items-center gap-3 pr-3 lg:pr-5 border-r border-outline-variant/30 dark:border-outline-variant/10 shrink-0">
          ...
          >
            <img
              ...
              alt="YourPets Logo"
              className="w-10 h-10 rounded-full object-cover border-2 border-[#002045]/20 dark:border-white/20 shadow-sm group-hover:scale-105 transition-transform shrink-0"
            />
